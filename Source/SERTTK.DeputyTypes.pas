...
{$ENDIF}
  ...
  strict private
    ...
    FHTTPReqDeputyVersion, FHTTPReqDeputyDL: TNetHTTPRequest; //FHTTPReqCaddie, FHTTPReqDemoFMX, FHTTPReqDemoVCL,
...
//          procedure
//          begin
//            if Assigned(OnDownloadCaddieDone) then
//              OnDownloadCaddieDone('Downloaded');
//          end);
//      end
